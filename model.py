...
class TimeDistributed(nn.Module):
    ...
    def embedding_with_padding(self, x, maxLength, length):
        ...
        ids = ids[indices]
        return ids.to(device), sortedLen.data.numpy().tolist(), reversedIndices.to(device)
...
class FeatureNet(nn.Module):
    ...
    def embedding_with_padding(self, feature, maxLength, length):
        ...
        return feature_.to(device), sortedLen.data.numpy().tolist(), reversedIndices.to(device)
